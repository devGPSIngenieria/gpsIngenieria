...
$resultados = [];
    ...
    if ( isset($_GET['descripcion']) && isset($_GET['detallado']) ) {
        ...
        if($detallado == 'true'){
            ...
            $queryProductos = "SELECT i.id_inventario, i.id_producto, i.no_serial, p.no_parte, p.descripcion, i.fecha_registro, i.tipo_movimiento" 
                                ...
                                ." WHERE i.id_producto = p.id_producto AND i.tipo_movimiento IN (4) AND i.id_estado = 1 " . $cadenaQuery . " " . $cadenaQueryIds;
