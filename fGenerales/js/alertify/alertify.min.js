...
!(function (a) {
  ...
  var n = ":not(:disabled):not(.ajs-reset)",
    ...
    p = {
      ...
      glossary: {
        title: "TI & TELECOMUNICACIONES",
        ok: "<i class='fa-solid fa-check fa-fade fa-lg' style='color: #02972f;'></i>",
        cancel: "<i class='fa-solid fa-xmark fa-fade fa-lg' style='color: #ff0000;'></i>",
        acccpt: "<i class='fa-solid fa-check fa-fade fa-lg' style='color: #02972f;'></i>",
        deny: "<i class='fa-solid fa-xmark fa-fade fa-lg' style='color: #ff0000;'></i>",
        confirm: "<i class='fa-solid fa-check fa-fade fa-lg' style='color: #02972f;'></i>",
        decline: "<i class='fa-solid fa-xmark fa-fade fa-lg' style='color: #ff0000;'></i>",
        close: "<i class='fa-solid fa-xmark fa-fade fa-lg' style='color: #ff0000;'></i>",
        maximize: "Maximizar",
        restore: "Restaurar",
      },
