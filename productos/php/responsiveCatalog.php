...
<!-- MODAL -->
<div class="modal fade" id="modalReturns" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-12 text-center">
                    <label class="text-subtitle">Hacer devoluciones</label>
                </div>

                <div class="table-responsive">
                    <table class="table" id="tableReturnsList"></table>
                </div>
            </div>
